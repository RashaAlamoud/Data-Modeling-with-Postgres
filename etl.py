...
def process_song_file(cur, filepath):
    """"Open Song File and insert records"""
...
def process_log_file(cur, filepath):
     ...
     """"Open Log File and insert records"""
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = (index, starttime, row.userId, row.level, songid, artistid, 
...
def process_data(cur, conn, filepath, func):
    ...
    """Get all files matching extension from directory and tatal number of files"""
